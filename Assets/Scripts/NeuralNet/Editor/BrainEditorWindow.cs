...
namespace NeuralNet.Editor
{
    public class BrainEditorWindow : EditorWindowSingleton<BrainEditorWindow>
    {
        ...
        {
            if (!AssetDatabase.IsValidFolder($"{Constants.Window.editorDataFolderPath}/{Constants.Window.editorDataFolderName}"))
            {
                var path = AssetDatabase.CreateFolder(Constants.Window.editorDataFolderPath, Constants.Window.editorDataFolderName);
            ...
            {
                var path = $"{Constants.Window.editorDataFolderPath}/{Constants.Window.editorDataFolderName}";
            ...
            State.SetCurrentNetworkAsset(CreateInstance<NeuralNetworkData>());
        }
